...
const validateCred = (arr) => {
    ...
    //add back the last digit dropped originally
...
const findInvalidCards = (nestedArr) => {
    ...
    for (let i = 0; i < nestedArr.length; i++) {
        let currCard = nestedArr[i];
        if(validateCred(currCard) === "invalid") {
...
const idInvalidCardCompanies = (nestedArr) => {
    ...
    invalidIssuers = removeDuplicates(invalidCardCompanies);
